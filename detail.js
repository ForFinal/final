const itemObj = {
            ...
            15: {category:'other',name: '突尼西亞100%天然耶棗/500克', price: '300', description: '超級食物椰棗，含有豐富維他命、礦物質、膳食纖維，而且含天然果糖，但升糖指數低，可以當作健康小食；為突尼西亞三寶之一。', img: 'jujube.jpg', pro: '存放於常溫，避免於高溫、潮濕、日光直射，開封後請於半個月內食用完畢。'},
        };
...
function newCardItem(item) {
    ...
    + '&pid=' + encodeURIComponent(item.pid) + '&pro=' + encodeURIComponent(item.pro) + '&from=' + encodeURIComponent(item.from)+ '">';
